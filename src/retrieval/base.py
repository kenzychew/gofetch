...
class BaseRetriever(ABC):
    ...
    async def retrieve(
        ...
        Args:
            ...
            query_embedding: The query's dense vector embedding, required by
                retrievers that search on embeddings (e.g. DenseRetriever)
                and ignored by retrievers that don't (e.g. sparse, graph).
